...
<form action="" method="post">
   ...
   <div class="cart-items">
      ...
      ?>
      <p><span class="name"><?= $fetch_cart['name']; ?></span><span class="price">Php: <?= $fetch_cart['price']; ?>.00 x <?= $fetch_cart['quantity']; ?></span></p>
      <?php
            }
         }else{
      ...
      ?>
      <p class="grand-total"><span class="name">Grand Total :</span><span class="price">Php: <?= $grand_total; ?>.00</span></p>
